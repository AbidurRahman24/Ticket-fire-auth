    ...
    return (
        <div>
            <div class="signup-form">
                ...
                {
                  newUser ? <div class="text-center">Already have an account? <input type='checkbox' onChange={() => setNewUser(!newUser)} name="newUser"/>Login here</div> :
                  <div class="text-center">Don't have an account <input type='checkbox' onChange={() => setNewUser(!newUser)} name="newUser"/>Creat an account</div>
                }
            </div>
